...
with open(experiment_parameters_path, newline='', mode='w', encoding="utf-8") as csv_file:
    ...
    writer.writerow(['rho_e', str(ethanol_density)])
    writer.writerow(['rho_w', str(water_density)])
    writer.writerow(['xi_theory', str(weight_percentage)])
    writer.writerow(['m_e_theory', str(weight_ethanol)])
    writer.writerow(['m_w_theory', str(weight_water)])
    writer.writerow(['xi_reality', str(actual_weight_percentage)])
